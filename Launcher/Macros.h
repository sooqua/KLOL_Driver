...
#define MAKE_FIELD(TYPE, ADDRESS) ( *reinterpret_cast<TYPE*>((DWORD) this + static_cast<__int32>(##ADDRESS)) )

#define MAKE_GETTER(NAME, TYPE, OFFSET) \
TYPE Get##NAME##() { \
	return *reinterpret_cast<TYPE*>((DWORD) this + static_cast<__int32>(OFFSET)); \
}

#define MAKE_GETTER_PTR(NAME, TYPE, OFFSET) \
TYPE##* Get##NAME##() { \
	return reinterpret_cast<TYPE*>((DWORD) this + static_cast<__int32>(OFFSET)); \
}